...
const Create_Listing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (listingId) {
      // UPDATE
      await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/listings/${listingId}`, {
        method: "PUT",
        headers: {
      ...
      // CREATE
      try {
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/listings`, {
          method: "POST",
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      try {
        const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/listings/${listingId}`);
        const data = await res.json();
